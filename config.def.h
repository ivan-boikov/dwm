...
static const Key keys[] = {
	...
	{ 0,                            XK_Print,                 spawn, SHCMD("maim pic-full-$(date '+%y%m%d-%H%M-%S').png && notify-send -t 500 'Screenshot taken'") },
	...
	{ 0,                            XF86XK_AudioMute,         spawn, SHCMD("pamixer -t    || wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ MODKEY|ControlMask,           XK_minus,                 spawn, SHCMD("pamixer -d 1  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%-  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ MODKEY,                       XK_minus,                 spawn, SHCMD("pamixer -d 5  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ MODKEY|ShiftMask,             XK_minus,                 spawn, SHCMD("pamixer -d 25 || wpctl set-volume @DEFAULT_AUDIO_SINK@ 25%- ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ MODKEY|ControlMask,           XK_equal,                 spawn, SHCMD("pamixer -i 1  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%+  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ MODKEY,                       XK_equal,                 spawn, SHCMD("pamixer -i 5  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ MODKEY|ShiftMask,             XK_equal,                 spawn, SHCMD("pamixer -i 25 || wpctl set-volume @DEFAULT_AUDIO_SINK@ 25%+ ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ ControlMask,                  XF86XK_AudioLowerVolume,  spawn, SHCMD("pamixer -d 1  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%-  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ 0,                            XF86XK_AudioLowerVolume,  spawn, SHCMD("pamixer -d 5  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ ShiftMask,                    XF86XK_AudioLowerVolume,  spawn, SHCMD("pamixer -d 25 || wpctl set-volume @DEFAULT_AUDIO_SINK@ 25%- ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ ControlMask,                  XF86XK_AudioRaiseVolume,  spawn, SHCMD("pamixer -i 1  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%+  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ 0,                            XF86XK_AudioRaiseVolume,  spawn, SHCMD("pamixer -i 5  || wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+  ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
	{ ShiftMask,                    XF86XK_AudioRaiseVolume,  spawn, SHCMD("pamixer -i 25 || wpctl set-volume @DEFAULT_AUDIO_SINK@ 25%+ ; sb-volume ; pkill --signal SIGUSR1 slstatus") },
